...
public class BowlingScoreTest {
    ...
    @Test
    public void testFrameTwoBallTwo() {
        ScoreSheet scoreSheet = new ScoreSheet();
        List<FrameScore> fsList = new ArrayList<>();
        ...
        assertEquals(12, BowlingScore.calculuateGameScore(scoreSheet));
    }

    @Test
    public void testFrameOneStrike() {
        ScoreSheet scoreSheet = new ScoreSheet();
        List<FrameScore> fsList = new ArrayList<>();
        ...
        assertEquals(28, BowlingScore.calculuateGameScore(scoreSheet));
    }
